...
<div class="lab-inner-page join-reference-page">
  ...
  <section class="join-reference-list">
    <article>
      ...
      <p> We are looking for highly motivated, passionate students who are interested in bio and healthcare systems, simulation-based optimization, or digital twins. Completion of a Simulation course and familiarity with Python are welcome.</p>
      <p>바이오·헬스케어 시스템, 시뮬레이션 기반 최적화, 디지털 트윈에 관심 있는 열정적이고 의욕적인 학생을 찾고 있습니다. 시뮬레이션 수강 경험과 Python 등 프로그래밍 경험이 있으면 좋습니다.</p>
    </article>
    <article>
