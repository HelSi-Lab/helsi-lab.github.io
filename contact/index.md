...
<div class="lab-inner-page contact-reference-page">
  <section class="lab-page-heading">
    ...
    <p>Healthcare &amp; Simulation Optimization Lab<br>헬스케어 및 시뮬레이션 최적화 연구실</p>
  </section>
  ...
  <section class="contact-reference-list">
    ...
    <article><h2>Principal Investigator <span>· 지도교수</span></h2><p>Prof. Serin Lee<br>Building 9, Room 409<br>9호관 409호</p></article>
